...
F1 and F2 to change text size F3 and F4 to change text box size Arrow up and down to scroll Enter to start typing Backspace to delete The currently supported commands are:
...
verb:music
event:audio/play/Bach/loop
event: audio/sync/Prokof/to/Bach
event: audio/play/Prokof/loop
event: audio/sync/whisper/to/Bach
event: audio/play/whisper/loop
event: audio/mute/Prokof/3
event: audio/mute/Bach/3
event: audio/fadeIn/Prokof/3
event: audio/fadeOut/Bach/10
